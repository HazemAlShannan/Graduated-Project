      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            erro.innerHTML = "".concat(_context.t0.response.data.message);
...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(email, password, passwordConfirm, name, gender) {
    var res, err;
...
exports.updateWsData = exports.updateBoardData = exports.show_todoBox = exports.show_tagMemBox = exports.show_tagBox = exports.show_editBoard = exports.show_card_profile = exports.show_S = exports.show_N = exports.showTooltip = exports.showMembers = exports.showHide_card = exports.showBoardBox = exports.openchooseMem = exports.openUpdatews = exports.notification_world = exports.notification = exports.deleteBoard = exports.createWS = exports.createNewBoard = exports.closes = exports.close_todoBox = exports.close_tagMemBox = exports.close_tagBox = exports.close_editBoard = exports.close_card_profile = exports.close_S = exports.closeUpdatews = exports.closeMemeber = exports.closeHide_card = exports.closeBoardBox = exports.closeAddMemeber = exports.applyChangeRole = exports.appear = exports.addNewMember = exports.acceptInvite = exports.AddMembers = void 0;
...
var maiiin = document.querySelector('.mainn');
var foot = document.querySelector('.footer');
var nav = document.querySelector('.navigation');
var create = document.querySelector('.create-model');
...
var closes = function closes() {
  create.style.display = 'none';
  heade.classList.remove('blur'); // maiiin.classList.remove("blur");
...
var createWS = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(wsName, type) {
    var res, errmsg;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              window.setTimeout(function () {
                window.location.assign("/".concat(res.data.data.slug));
              }, 1500);
            }
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            console.log('wtf', _context.t0.response.data.message);
            errmsg = document.querySelector('.hide_Error');
            errmsg.innerHTML = "".concat(_context.t0.response.data.message);
  ...
  return function createWS(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.createWS = createWS;
var plus_box = document.querySelector('.plus-box');
var cancelPlus = document.querySelector('.cancelPlus');

var AddMembers = function AddMembers() {
  plus_box.style.display = 'block'; // heade.classList.add('blur');
...
var closeAddMemeber = function closeAddMemeber() {
  plus_box.style.display = 'none'; // heade.classList.remove('blur');
...
exports.closeAddMemeber = closeAddMemeber;
var cancelUser = document.querySelector('.close-mem');
var name_mem = document.querySelector('.name-mem');

var showMembers = function showMembers() {
  name_mem.style.display = 'block'; // heade.classList.add('blur');

  foot.classList.add('blur');
  nav.classList.add('blur');
  maiiin.classList.add('blur'); // adduserIcon.classList.add('blur');
  // worldIcon.classList.add('blur');
};

exports.showMembers = showMembers;

var closeMemeber = function closeMemeber() {
  name_mem.style.display = 'none'; // memchoose.style.display = 'none';

  foot.classList.remove('blur');
  nav.classList.remove('blur');
  maiiin.classList.remove('blur'); // adduserIcon.classList.remove('blur');
};

exports.closeMemeber = closeMemeber;
var Pmain = document.querySelector('.create-icon');
var board_box = document.querySelector('.create-B');

var showBoardBox = function showBoardBox() {
  board_box.style.display = 'block'; // heade.classList.add('blur');
...
exports.showBoardBox = showBoardBox;
var Closeboard_box = document.querySelector('.cancel-board');

var closeBoardBox = function closeBoardBox() {
  board_box.style.display = 'none'; // heade.classList.remove('blur');
...
exports.closeBoardBox = closeBoardBox;

var addNewMember = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id, email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var createNewBoard = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(bName, bEndDate, bDescription, workspace) {
    var res, errmsg;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            console.log(_context3.t0.response.data.message);
            errmsg = document.querySelector('.hide_Error');
            errmsg.innerHTML = "".concat(_context3.t0.response.data.message);
            errmsg.style.display = 'block';
  ...
  return function createNewBoard(_x5, _x6, _x7, _x8) {
    return _ref3.apply(this, arguments);
  };
}();

exports.createNewBoard = createNewBoard;
var show_cardProfile = document.querySelectorAll('.profile-card');

var show_card_profile = function show_card_profile(backId) {
  show_cardProfile.forEach(function (card) {
...
exports.show_card_profile = show_card_profile;

var close_card_profile = function close_card_profile() {
  show_cardProfile.forEach(function (card) {
    return card.style.display = 'none';
  });
};

exports.close_card_profile = close_card_profile;
var icon_search = document.querySelector('.icon-search');
var search = document.querySelector('.search');
var search_close = document.querySelector('.clear-search');

var show_S = function show_S() {
  search.classList.add('search_active');
};

exports.show_S = show_S;

var close_S = function close_S() {
  search.classList.remove('search_active');
};

exports.close_S = close_S;

var show_N = function show_N() {
  var wrappeer_Task = document.querySelectorAll('.wrappeer');
  wrappeer_Task.forEach(function (wrapeer) {
    return wrapeer.classList[1];
  });
};

exports.show_N = show_N;
var mainTo = document.querySelector('.mainnn');
var createtodoList_box = document.querySelector('.create-todoListBox');

var show_todoBox = function show_todoBox() {
...
exports.show_todoBox = show_todoBox;

var close_todoBox = function close_todoBox() {
  if (createtodoList_box) {
...
exports.close_todoBox = close_todoBox;
var tags_box = document.querySelectorAll('.tags');

var show_tagBox = function show_tagBox(btnId) {
  tags_box.forEach(function (el) {
...
exports.show_tagBox = show_tagBox;

var close_tagBox = function close_tagBox() {
  tags_box.forEach(function (el) {
    // if (el.dataset.cardid === btnId) {
...
exports.close_tagBox = close_tagBox;
var tagMem_box = document.querySelectorAll('.memTags-Todolis');

var show_tagMemBox = function show_tagMemBox(num) {
  tagMem_box.forEach(function (el) {
...
exports.show_tagMemBox = show_tagMemBox;

var close_tagMemBox = function close_tagMemBox() {
  tagMem_box.forEach(function (el) {
    el.style.display = 'none';
    foot.classList.remove('blur');
    mainTo.classList.remove('blur');
...
exports.close_tagMemBox = close_tagMemBox;

var deleteBoard = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(boardId) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            }).then(console.log('Board deleted successfully')).then(window.setTimeout(function () {
  ...
  return function deleteBoard(_x9) {
    return _ref4.apply(this, arguments);
  };
}();

exports.deleteBoard = deleteBoard;
var noti = document.querySelector('.notification-box');
var notiul = document.querySelector('.notification ul');
var notinum = document.querySelector('.num-notification');
var nNUM = document.querySelector('.notiNum');

var notification = function notification() {
  noti.onclick = function () {
    notiul.classList.toggle('show-ulNote');
    notinum.style.display = 'none'; // nNUM.style.display = 'none'
  };
};

exports.notification = notification;
var noti_world = document.querySelector('.dropdown-world');
var world_icon = document.querySelector('.bx-world');
var world_num = document.querySelector('.numW');

var notification_world = function notification_world() {
...
exports.notification_world = notification_world;
var toggleBttnM = document.querySelector('.bx-flip-horizontal');
var toggleBttnX = document.querySelector('.bx-message-alt-x');
var backtask = document.querySelectorAll('.backtask');

var showHide_card = function showHide_card() {
  backtask.forEach(function (task) {
    return task;
  });
  var count = backtask.dataset.bigc;
  console.log(count);
...
exports.showHide_card = showHide_card;

var closeHide_card = function closeHide_card() {
...
exports.closeHide_card = closeHide_card;
var editBoards = document.querySelectorAll('.edittB');

var show_editBoard = function show_editBoard(boardId) {
  editBoards.forEach(function (editBoard) {
    var id = editBoard.dataset.idforboard;
...
exports.show_editBoard = show_editBoard;

var close_editBoard = function close_editBoard() {
  editBoards.forEach(function (el) {
    el.style.display = 'none';
    heade.classList.remove('blur'); // maiiin.classList.remove("blur");
...
exports.close_editBoard = close_editBoard;
var memchoose = document.querySelectorAll('.updatemem');

var openchooseMem = function openchooseMem(userId) {
  if (memchoose) memchoose.forEach(function (el) {
    if (el.dataset.userid === userId) el.style.display = 'block';
  });
};

exports.openchooseMem = openchooseMem;
var editWS = document.querySelector('.Update-model');
var notiIcon = document.querySelector('.notification');
var adduserIcon = document.querySelector('.add.user');
var worldIcon = document.querySelector('.world');

var openUpdatews = function openUpdatews() {
...
exports.openUpdatews = openUpdatews;

var closeUpdatews = function closeUpdatews() {
...
exports.closeUpdatews = closeUpdatews;

var acceptInvite = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(accept, wsId) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            console.error('error', _context5.t0.response.data.message);
  ...
  return function acceptInvite(_x10, _x11) {
...
var applyChangeRole = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(userId, newRole, wsId) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            console.error('error', _context6.t0.response.data.message);
  ...
  return function applyChangeRole(_x12, _x13, _x14) {
    return _ref6.apply(this, arguments);
  };
}();

exports.applyChangeRole = applyChangeRole;

var updateWsData = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(wsName, wsDescreption, type, wsId) {
    var res;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:5000/api/v1/workspaces/".concat(wsId),
              data: {
                wsName: wsName,
                wsDescreption: wsDescreption,
                type: type
              }
            });
          ...
          case 8:
            ...
            console.error('error', _context7.t0.response.data.message);
  ...
  return function updateWsData(_x15, _x16, _x17, _x18) {
    return _ref7.apply(this, arguments);
  };
}();

exports.updateWsData = updateWsData;

var updateBoardData = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(bName, bDescreption, bEndDate, bId) {
    var res;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:5000/api/v1/boards/".concat(bId),
              data: {
                bName: bName,
                bDescreption: bDescreption,
                bEndDate: bEndDate
              }
            });
          ...
          case 9:
            ...
            console.error('error', _context8.t0.response.data.message);
  ...
  return function updateBoardData(_x19, _x20, _x21, _x22) {
    return _ref8.apply(this, arguments);
  };
}();

exports.updateBoardData = updateBoardData;
},{"axios":"../node_modules/axios/index.js"}],"profile.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editProfileInfo = void 0;
...
var editProfileInfo = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            console.log('wtf', _context.t0.response);
            console.log('wtf', _context.t0.response.data);
            console.log('wtf', _context.t0.response.data.message);
  ...
  return function editProfileInfo(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.editProfileInfo = editProfileInfo;
},{"axios":"../node_modules/axios/index.js"}],"card.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tagNewMember = exports.deleteCard = exports.createCard = exports.checkItAsDone = exports.addNewTask = void 0;
...
var createCard = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(cardName, bId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function createCard(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var addNewTask = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(task, cardId) {
    var res, errmsg;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            errmsg = document.querySelector('.hide_Error');
            errmsg.innerHTML = "".concat(_context2.t0.response.data.message);
            errmsg.style.display = 'block';
  ...
  return function addNewTask(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
var checkItAsDone = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(isDone, cardId, taskName) {
    var res, errmsg;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              console.log('checkbox changed successfully !!'); // window.setTimeout(() => window.location.reload(true), 500);
            }
  ...
  return function checkItAsDone(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();

exports.checkItAsDone = checkItAsDone;
...
var deleteCard = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            }).then(console.log('card deleted successfully')).then(window.setTimeout(function () {
              location.reload(true);
            }, 500));
  ...
  return function deleteCard(_x8) {
    return _ref4.apply(this, arguments);
  };
}();
...
var tagNewMember = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(email, cardId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
  ...
  return function tagNewMember(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();

exports.tagNewMember = tagNewMember;
...
var toolip_element = document.querySelectorAll('.tooltip-element');
var btn = document.querySelector('.btnn');
var close_create = document.querySelector('.closes');
var createForm = document.querySelector('.create-form');
var add_i = document.querySelector('.plus-i');
var add_user = document.querySelector('.user');
var addMember = document.querySelector('.add-u');
var cancelPlus = document.querySelector('.cancelPlus');
var cancelUser = document.querySelector('.close-mem');
var Pmain = document.querySelector('.create-icon');
var board_box = document.querySelector('.create-B');
var Closeboard_box = document.querySelector('.cancel-board');
var createBoardForm = document.querySelector('.create-new-board');
var show_card = document.querySelectorAll('.show-card');
var close_cardPro = document.querySelectorAll('.close-profileCard ');
var openBoard = document.querySelectorAll('.open-board');
var profileForm = document.querySelector('.profile-form');
var getingReadyPage = document.querySelectorAll('.btn-op');
var openInvitedWS = document.querySelectorAll('.invet-btn');
var seemore_Btn = document.querySelectorAll('.seemore');
var imgTag_btn = document.querySelectorAll('.tagImg');
var publicWorkspaces = document.querySelectorAll('.publicWork-btn');
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    if (name && email && password && gender && passwordConfirm && passwordConfirm === password) {
      console.log(name, email, password, passwordConfirm, gender);
      (0, _login.signup)(email, password, passwordConfirm, name, gender);
    } else {
...
if (sign_up_btn) sign_up_btn.addEventListener('click', function () {
  contanier.classList.add('sign-up-mode');
});
if (sign_in_btn) sign_in_btn.addEventListener('click', function () {
  contanier.classList.remove('sign-up-mode');
});
if (toolip_element) toolip_element.forEach(function (ele) {
  ele.addEventListener('mouseover', _main.showTooltip);
});
if (btn) btn.addEventListener('click', function () {
  return (0, _main.appear)();
});
if (close_create) close_create.addEventListener('click', _main.closes);
if (createForm) createForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var wsName = document.getElementById('ws-name').value; // if (document.getElementById('public').checked) console.log('gere');
  // if (document.getElementById('private').checked) console.log('pubv here');

  if (document.getElementById('private').checked) return (0, _main.createWS)(wsName, 'private');
  if (document.getElementById('public').checked) return (0, _main.createWS)(wsName, 'public');
});
if (add_i) add_i.addEventListener('click', function () {
  return (0, _main.AddMembers)();
});
if (add_user) add_user.addEventListener('click', function () {
  return (0, _main.showMembers)();
});
if (cancelPlus) cancelPlus.addEventListener('click', function () {
  return (0, _main.closeAddMemeber)();
});
if (cancelUser) cancelUser.addEventListener('click', function () {
  return (0, _main.closeMemeber)();
});
window.addEventListener('scroll', function () {
  var header = this.document.querySelector('header');
  header.classList.toggle('sticky', window.scrollY > 0);
});
if (Pmain) Pmain.addEventListener('click', function () {
  return (0, _main.showBoardBox)();
});
if (Closeboard_box) Closeboard_box.addEventListener('click', function () {
  return (0, _main.closeBoardBox)();
});
if (addMember) addMember.addEventListener('click', function () {
  var email = document.getElementById('add-email').value.toLowerCase();
  var id = document.getElementById('input').dataset.id;
  console.log('ss', email, id);
  (0, _main.addNewMember)(id, email);
});
if (createBoardForm) createBoardForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var bName = document.getElementById('bName').value;
  var bEndDate = document.getElementById('bDate').value;
  var bDescription = document.getElementById('bDesc').value;
  var workspace = document.getElementById('input').dataset.id;
  (0, _main.createNewBoard)(bName, bEndDate, bDescription, workspace);
});
if (show_card) show_card.forEach(function (card) {
  var backId = card.dataset.backid;
  card.addEventListener('click', function () {
    return (0, _main.show_card_profile)(backId);
  });
});
if (close_cardPro) close_cardPro.forEach(function (card) {
  return card.addEventListener('click', function () {
    return (0, _main.close_card_profile)();
  });
});
if (openBoard) openBoard.forEach(function (board) {
  board.addEventListener('click', function () {
    console.log('hi');
    var url = window.location.href;
    if (url.charAt(url.length - 1) === '/') url = url.substring(0, url.length - 1); // console.log(url.charAt(url.length - 1));

    window.location.assign("".concat(url, "/").concat(board.dataset.boardname));
  });
});
var image = document.getElementById('image');

if (image) {
  var images = ['/img/4.svg', '/img/2svg.svg', '/img/3svg.svg', '/img/5.svg', '/img/1v.svg'];
...
if (profileForm) {
  profileForm.addEventListener('submit', function (e) {
    ...
    if (document.getElementById('profileName').value) form.append('name', document.getElementById('profileName').value);
    if (document.getElementById('profileEmail').value) form.append('email', document.getElementById('profileEmail').value);
    form.append('password', document.getElementById('profilePassword').value);
    form.append('passwordConfirm', document.getElementById('profilePasswordConfirm').value);
    form.append('position', document.getElementById('profilePosation').value);
    form.append('photo', document.getElementById('photo').files[0]);
    (0, _profile.editProfileInfo)(form);
  });
}

if (getingReadyPage) getingReadyPage.forEach(function (el) {
  el.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var userInterests, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            userInterests = el.dataset.type;
...
if (openInvitedWS) openInvitedWS.forEach(function (workspace) {
  return workspace.addEventListener('click', function () {
    window.location.assign("/invitedWS/".concat(workspace.dataset.invited));
  });
}); // if (seemore_Btn)
...
if (publicWorkspaces) publicWorkspaces.forEach(function (workspace) {
  return workspace.addEventListener('click', function () {
    return window.location.assign("/publicWorkspace/".concat(workspace.dataset.publicws));
  });
});
var plusCreate_todoBox = document.querySelector('.bx-plus-circle');
if (plusCreate_todoBox) plusCreate_todoBox.addEventListener('click', function () {
  return (0, _main.show_todoBox)();
});
var x_todoBox = document.querySelector('.bx-tada');
if (x_todoBox) x_todoBox.addEventListener('click', function () {
  return (0, _main.close_todoBox)();
}); // var color = document.getElementById('.create-todoListBox')

var colorBox = ['#dbc271ad', '#895ec37d', '#80893ba6', '#cf24db7a', '#0c244afa'];
var i = 0;
var todoColor = document.querySelector('.bx-plus-circle');
if (todoColor) todoColor.addEventListener('click', function () {
  i = i < colorBox.length ? ++i : 0;
  document.querySelector('.create-todoListBox').style.background = colorBox[i];
  document.querySelector('.create-todoListBox input').style.color = colorBox[i];
});
var inputTags = document.querySelector('.inputTags');
var tagsBtn = document.querySelector('.tag-user'); // const ulTags = document.querySelector('.ulTags');
// if (tagsBtn)
...
var tagplusBtn = document.querySelectorAll('.tag-btn');
var tagxBtn = document.querySelectorAll('.closeTag');
if (tagplusBtn) tagplusBtn.forEach(function (btn) {
  var btnId = btn.dataset.cardid;
  btn.addEventListener('click', function () {
    return (0, _main.show_tagBox)(btnId);
  });
});
if (tagxBtn) tagxBtn.forEach(function (el) {
  return el.addEventListener('click', function () {
    return (0, _main.close_tagBox)();
  });
});
var tagMemBtn = document.querySelectorAll('.img-tag .bx');
var tagMemx = document.querySelectorAll('.closememTags');
if (tagMemBtn) tagMemBtn.forEach(function (el) {
  el.addEventListener('click', function () {
    var num = el.dataset.index;
    console.log(num);
    (0, _main.show_tagMemBox)(num);
  });
});
if (tagMemx) tagMemx.forEach(function (el) {
  return el.addEventListener('click', function () {
    return (0, _main.close_tagMemBox)();
  });
...
var createCardBtn = document.querySelector('.create-card');
if (createCardBtn) createCardBtn.addEventListener('click', function () {
  var cardName = document.getElementById('cardname').value;
  var boardId = window.location.href.split('/').slice(-1)[0];
  console.log(cardName, boardId);
  (0, _card.createCard)(cardName, boardId);
});
var createTaskOnCard = document.querySelectorAll('.create-task');

if (createTaskOnCard) {
  var tasks = document.getElementsByClassName('add-task-in');
  createTaskOnCard.forEach(function (el) {
    el.addEventListener('click', function () {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (task.dataset.count === el.dataset.count) {
            ...
            (0, _card.addNewTask)(task.value, cardId);
          }
        }
      } catch (err) {
        _iterator.e(err);
...
var createTaskBig = document.querySelectorAll('.create-task-big');

if (createTaskBig) {
  var bigTasks = document.getElementsByClassName('task-data-big');
  createTaskBig.forEach(function (el) {
    return el.addEventListener('click', function () {
      var cardId = el.dataset.cardid;
      console.log(cardId);

      var _iterator2 = _createForOfIteratorHelper(bigTasks),
          _step2;
...
var see = document.querySelectorAll('.see');

if (see) {
  var backtask = document.querySelectorAll('.backtask');
  see.forEach(function (el) {
    return el.addEventListener('click', function () {
      backtask.forEach(function (bigCard) {
        if (bigCard.dataset.bigc === el.dataset.count) bigCard.classList.toggle('show-task');
      });
    });
  });
}
...
var noti = document.querySelector('.notification-box');
if (noti) noti.addEventListener('click', function () {
  return (0, _main.notification)();
});
var checkTaskDone = document.querySelectorAll('.checkbox');
if (checkTaskDone) checkTaskDone.forEach(function (el) {
  return el.addEventListener('change', function () {
    var taskName = '';
    var cardId = el.dataset.cardid;
    var checkbodId = el.id;
    var taskEl = document.querySelectorAll("p.taskname");
    taskEl.forEach(function (task) {
    ...
    if (this.checked) {
      ...
      (0, _card.checkItAsDone)(true, cardId, taskName);
    } else {
      console.log('not checked', cardId, taskName);
      (0, _card.checkItAsDone)(false, cardId, taskName);
    }
  });
});
var checkTaskDoneBig = document.querySelectorAll('.checkbox-big');
if (checkTaskDoneBig) checkTaskDoneBig.forEach(function (el) {
  return el.addEventListener('change', function () {
    var taskName = '';
    var cardId = el.dataset.cardid;
    var checkbodId = el.id;
    var taskEl = document.querySelectorAll("p.taskname-big");
    taskEl.forEach(function (task) {
      if (task.id === checkbodId) {
        taskName = task.innerText;
      }
...
var deleteBoardBtn = document.querySelectorAll('.delete-card-btn');
if (deleteBoardBtn) deleteBoardBtn.forEach(function (btn) {
  var boardId = btn.dataset.boardid;
  btn.addEventListener('click', function () {
    (0, _main.deleteBoard)(boardId);
  });
});
var deleteCardBtn = document.querySelectorAll('.delete-card');
if (deleteCardBtn) deleteCardBtn.forEach(function (btn) {
  var cardId = btn.dataset.cardid;
  btn.addEventListener('click', function () {
    (0, _card.deleteCard)(cardId);
  });
});
var world_icon = document.querySelector('.bx-world');
if (world_icon) world_icon.addEventListener('click', function () {
  return (0, _main.notification_world)();
}); //canvas

var editicon = document.querySelectorAll('.bx-edit-alt');
var closeediticon = document.querySelectorAll('.cancel-edit');
if (editicon) editicon.forEach(function (el) {
  var boardId = el.dataset.editboardid;
  el.addEventListener('click', function () {
    console.log(boardId);
    (0, _main.show_editBoard)(boardId);
  });
});
if (closeediticon) closeediticon.forEach(function (el) {
  return el.addEventListener('click', function () {
    return (0, _main.close_editBoard)();
  });
});
var memdots = document.querySelectorAll('.bx-dots-horizontal-rounded');
if (memdots) memdots.forEach(function (el) {
  return el.addEventListener('click', function () {
    console.log(el.dataset.userid);
    (0, _main.openchooseMem)(el.dataset.userid);
  });
});
var updateWSIcon = document.querySelectorAll('.bxs-edit-alt');
if (updateWSIcon) updateWSIcon.forEach(function (el) {
  return el.addEventListener('click', function () {
    return (0, _main.openUpdatews)();
  });
});
var cancelEditWS = document.querySelectorAll('.updatecloses');
if (cancelEditWS) cancelEditWS.forEach(function (el) {
  return el.addEventListener('click', function () {
    return (0, _main.closeUpdatews)();
  });
});
var tagsForm = document.querySelectorAll('.tag-note');
if (tagsForm) tagsForm.forEach(function (form) {
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var inputs = document.querySelectorAll('.inputTags');
    inputs.forEach(function (input) {
      if (input.dataset.cardid === form.dataset.cardid) {
        var textValue = input.value;
        var btns = document.querySelectorAll('.tag-user');
        btns.forEach(function (btn) {
          if (btn.dataset.cardid === form.dataset.cardid) {
            var email = textValue.toLowerCase();
            console.log(email, btn.dataset.cardid);
            (0, _card.tagNewMember)(email, btn.dataset.cardid);
          }
        });
      }
    });
...
var acceptInvitation = document.querySelectorAll('.accept');
if (acceptInvitation) acceptInvitation.forEach(function (invite) {
  invite.addEventListener('click', function () {
    return (0, _main.acceptInvite)(true, invite.dataset.inviteid);
  });
});
var declineInvitation = document.querySelectorAll('.not');
if (declineInvitation) declineInvitation.forEach(function (invite) {
  invite.addEventListener('click', function () {
    console.log(invite.dataset.inviteid);
    (0, _main.acceptInvite)(false, invite.dataset.inviteid);
  });
});
var searchPublicWS = document.querySelector('.icon-search');

if (searchPublicWS) {
  console.log('hi');
  searchPublicWS.addEventListener('click', function () {
    var newSeach = document.querySelector('.search');
    console.log(newSeach, newSeach.classList, newSeach.classList.contains('search_active'));
    var searchActivate = document.getElementById('search-public');

    if (newSeach.classList.contains('search_active')) {
      var name = searchActivate.value.toLowerCase().split(' ').join('-');
      console.log(name);
      window.location.assign("/publicWorkspaces/search/".concat(name));
    }
  });
}
...
var icon_search = document.querySelector('.icon-search');
var search_close = document.querySelector('.clear-search');
if (icon_search) icon_search.addEventListener('click', function () {
  return (0, _main.show_S)();
});
if (search_close) search_close.addEventListener('click', function () {
  return (0, _main.close_S)();
});
var getTaggedCardsBoard = document.querySelectorAll('.li-tag-on-card');
if (getTaggedCardsBoard) getTaggedCardsBoard.forEach(function (el) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            ...
            console.error('error', _context2.t0.response.data.message);
...
var changeRole = document.querySelectorAll('.update-role-members');

if (changeRole) {
  changeRole.forEach(function (el) {
    el.addEventListener('click', function (e) {
      console.log(e.target);
      console.log('ddd', e.target.dataset.role);
      console.log(e.target.dataset.userid);
      var currentRole = document.querySelectorAll('.user-current-role');
      currentRole.forEach(function (elm) {
        console.log(elm);

        if (elm.dataset.userid === e.target.dataset.userid) {
          // if (elm.dataset.role !== e.target.dataset.role) {
          console.log('hi', ' need to return');
          (0, _main.applyChangeRole)(e.target.dataset.userid, e.target.dataset.role, e.target.dataset.wsid); // }
        }
      });
    });
  });
...
var updateWsForm = document.querySelector('.update-ws-form');
if (updateWsForm) updateWsForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var wsId = updateWsForm.dataset.wsid;
  var wsName = document.getElementById('wsup-name').value;
  var wsDescreption = document.getElementById('wsup-des').value;
  var type = '';
  if (document.getElementById('updatepublic').checked) type = 'public';
  if (document.getElementById('updateprivate').checked) type = 'private';
  (0, _main.updateWsData)(wsName, wsDescreption, type, wsId);
});
var updateBoardForm = document.querySelectorAll('.update-board-form');
if (updateBoardForm) updateBoardForm.forEach(function (form) {
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var bName = form.childNodes[2].childNodes[1].value;
    var bDescreption = form.childNodes[4].childNodes[1].value;
    var bEndDate = form.childNodes[3].childNodes[1].value;
    var bId = form.dataset.bid;
    (0, _main.updateBoardData)(bName, bDescreption, bEndDate, bId);
  });
});
var resetDefaultWS = document.querySelector('#reset-ws');
if (resetDefaultWS) resetDefaultWS.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
  var wsIdForReset, res;
  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          wsIdForReset = resetDefaultWS.dataset.wsid;
          _context3.prev = 1;
          _context3.next = 4;
          return (0, _axios.default)({
            method: 'DELETE',
        ...
        case 8:
          ...
          console.error('error', _context3.t0.response.data.message);
...
var deleteWS = document.querySelectorAll('.delete-ws');
if (deleteWS) deleteWS.forEach(function (el) {
  // console.log('hi');
  var deletedWS = el.dataset.wsid;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            }).then(console.log('final proccess')).then(window.location.replace('/'));
          ...
          case 6:
            _context4.prev = 6;
            _context4.t0 = _context4["catch"](0);
            console.error('error', _context4.t0.response.data.message);
